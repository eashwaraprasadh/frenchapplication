      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            <a href="/login" className="font-medium text-sm text-slate-600 hover:text-blue-600 transition-colors uppercase tracking-wider">
              Sign In
            </a>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <a href="/login" onClick={() => setIsOpen(false)} className="font-medium p-3 rounded-sm transition-colors text-sm uppercase tracking-wide text-slate-600 hover:text-blue-600">
              Sign In
            </a>
