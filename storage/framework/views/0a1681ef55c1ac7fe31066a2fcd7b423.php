...
<?php $__env->startSection('title', 'TS Language Learning Platform - Master French Online'); ?>
            ...
            <div class="col-12 text-center hero-content">
                <div class="hero-text-wrapper">
                    ...
                    <div class="hero-buttons reveal-buttons mt-5">
                        <a href="<?php echo e(route('register')); ?>" class="btn-minimal btn-minimal-dark">
                            Start Learning
                        </a>
                        <a href="<?php echo e(route('courses.index')); ?>" class="btn-minimal btn-minimal-light">
                            Browse Courses
                        </a>
                    </div>
                </div>
        ...
        <div class="row text-center g-5">
            <div class="col-md-3 col-6">
                <div class="stat-minimal scroll-reveal">
                    <h2 class="stat-number-minimal" data-target="<?php echo e($stats['total_students']); ?>">0</h2>
                    <p class="stat-label">Students</p>
                </div>
            </div>
            <div class="col-md-3 col-6">
                <div class="stat-minimal scroll-reveal">
                    <h2 class="stat-number-minimal" data-target="<?php echo e($stats['total_courses']); ?>">0</h2>
                    <p class="stat-label">Courses</p>
                </div>
            </div>
            <div class="col-md-3 col-6">
                <div class="stat-minimal scroll-reveal">
                    <h2 class="stat-number-minimal" data-target="<?php echo e($stats['total_lessons']); ?>">0</h2>
                    <p class="stat-label">Lessons</p>
                </div>
            </div>
            <div class="col-md-3 col-6">
                <div class="stat-minimal scroll-reveal">
                    <h2 class="stat-number-minimal" data-target="<?php echo e($stats['total_enrollments']); ?>">0</h2>
...
<section class="courses-section scroll-section py-5" data-scroll-section id="courses">
    <div class="container">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="course-card-new scroll-reveal">
                        <div class="course-image-wrapper">
                            <div class="course-image" style="background-image: url('https://images.unsplash.com/photo-<?php echo e(['1499856871958-5b9627545d1a', '1502602898657-3e91760cbb34', '1511739001486-6bfe10ce785f', '1546410531-bb4caa6b424d', '1488190211105-8b0e65b80b4e', '1434030216411-0b793f4b4173'][$index % 6]); ?>?w=600&q=80');"></div>
                            <div class="course-overlay">
                                <?php if($course->price == 0): ?>
                                    <span class="course-badge">Free</span>
                                <?php else: ?>
                                    <span class="course-badge">$<?php echo e($course->price); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="course-content-new">
                            <div class="course-level-badge"><?php echo e(ucfirst($course->level)); ?></div>
                            <h5 class="course-title-new"><?php echo e($course->title); ?></h5>
                            <p class="course-description-new"><?php echo e(Str::limit($course->description, 100)); ?></p>
                            <div class="course-meta-new">
                                ...
                                <div class="course-meta-item">
                                    ...
                                    <span><?php echo e($course->duration_hours); ?>h</span>
                                </div>
                            </div>
                            <a href="<?php echo e(route('courses.show', $course)); ?>" class="course-btn-new">
                                Enroll Now
                            </a>
                        </div>
                    </div>
        ...
        <div class="text-center mt-5 scroll-reveal">
            <a href="<?php echo e(route('courses.index')); ?>" class="btn-minimal btn-minimal-dark">
                View All Courses
            </a>
        </div>
    </div>
            ...
            <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4">
                    <div class="testimonial-minimal scroll-reveal">
                        <p class="testimonial-text-minimal">"<?php echo e($testimonial['content']); ?>"</p>
                        <div class="testimonial-author-minimal">
                            <p class="author-name-minimal"><?php echo e($testimonial['name']); ?></p>
                            <p class="author-role-minimal"><?php echo e($testimonial['role']); ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row align-items-center min-vh-100">
            <div class="col-12 text-center scroll-reveal">
                ...
                <div class="cta-buttons-minimal mt-5">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn-minimal btn-minimal-light">
                        Sign In
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('courses.index')); ?>">Lessons</a></li>
                    <li><a href="<?php echo e(route('courses.index')); ?>">Tests</a></li>
                    <li><a href="<?php echo e(route('courses.index')); ?>">Support</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/eash/Downloads/Hostedfrench/resources/views/home.blade.php ENDPATH**/ ?>