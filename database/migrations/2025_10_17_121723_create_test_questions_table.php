...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('test_questions', function (Blueprint $table) {
            ...
            $table->enum('type', ['mcq', 'mcq_image', 'audio', 'video', 'drag_drop', 'text_input', 'fill_blanks', 'image_audio_mcq', 'passage_mcq']);
            $table->text('question_text');
            $table->text('passage')->nullable(); // for passage_mcq type
